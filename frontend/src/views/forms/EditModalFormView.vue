        ...
        <div class="em-form">
          ...
          <div class="em-danger-zone">
            <BaseButton variant="ghost" size="sm" @click="confirmDelete">
              <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="margin-right:var(--wx-space-1)"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>
              Xóa sản phẩm
            </BaseButton>
          </div>
        </div>
...
.em-table th { padding: 10px 14px; text-align: left; font-size: var(--wx-fs-12); font-weight: var(--wx-fw-bold); text-transform: uppercase; letter-spacing: .5px; color: var(--wx-text-muted); border-bottom: 1px solid var(--wx-border-subtle); background: var(--wx-surface-sunken); white-space: nowrap; }
.em-table td { padding: var(--wx-space-3) 14px; border-bottom: 1px solid var(--wx-border-subtle); color: var(--wx-text-primary); }
...
.em-badge { display: inline-flex; padding: 2px var(--wx-space-2); border-radius: var(--wx-radius-full); font-size: 11px; background: var(--wx-surface-sunken); border: 1px solid var(--wx-border-subtle); color: var(--wx-text-secondary); }
